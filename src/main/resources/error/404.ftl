<#-- @ftlvariable name="" type="com.mongodb.dibs.resources.ErrorView" -->
<!DOCTYPE html>
    ...
    <body>
        <div class="dashboard">
            <div id="content">
                ...
                <center><img id="error-image" src="/assets/images/404/${image}"></center>
                I don't know much.  And this is one of those things.
